...
export default function DomHead({ pageName = "Home Page" }) {
    ...
    return (
        <Head>
            ...
            {/* meta tags begins */}
            {/* Primary Meta Tags */}
            <meta name="title" content="Aditya- Personal Portfolio." />
            <meta name="description" content="Generated using BaayMax." />
            {/* Open Graph / Facebook */}
            <meta property="og:type" content="website" />
            <meta property="og:url" content="https://github.com/DRAKEnN9" />
            <meta property="og:title" content="Aditya- Personal Portfolio" />
